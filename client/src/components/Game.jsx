...
// import { game } from './game-script.js';

// const Game = () => {
  
//   useEffect(() => {
//     // Run the game when the component mounts
//     game.startGame();
...
//           <p>Click, tap, or press Space to start the game</p>
//         </div>
//       </div>
//       <div id="results">
//         <div className="content">
...
//       </a>
//       <div id="youtube-card">Learn Three.js + Cannon.js while building this game</div>
//     </div>
//   );
// };
...
//   return (
//     <div>
//       {/* Your existing Game component content */}
//     </div>
//   );
// };
...
function setRobotPrecision() {
  ...
  window.addEventListener("resize", () => {
    ...
    // Set up renderer
    const rendererr = new THREE.WebGLRenderer({ antialias: false });
    rendererr.setSize(window.innerWidth, window.innerHeight);
    canvasContainerRef.current.appendChild(rendererr.domElement);

    // ... (other Three.js initialization code)
